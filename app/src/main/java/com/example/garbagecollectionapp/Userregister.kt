...
import com.example.garbagecollectionapp.databinding.ActivityUserregisterBinding
import com.google.firebase.auth.FirebaseAuth
import com.google.firebase.database.DatabaseReference
import com.google.firebase.database.FirebaseDatabase
import java.util.regex.Pattern

class Userregister : AppCompatActivity(), View.OnClickListener, View.OnFocusChangeListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.loginButton.setOnClickListener {
            ...
            if (validateInputs(name, address, email, password)) {
    ...
    private fun validateInputs(name: String, address: String, email: String, password: String): Boolean {
        return validateName() && validateAddress()  && validateEmail() && validatePassword()
    }
